...
public class Authentication extends AppCompatActivity {
    ...
    private void registerUser() {
        ...
        if(TextUtils.isEmpty(phone)){
            Toast.makeText(this, "Phone Number를를 입력해주세요", Toast.LENGTH_SHORT).show();
            return;
        }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            databaseReference.child("DOSE").setValue("0");
                            databaseReference.child("HISTORY").setValue("0");
                            databaseReference.child("OUTING").setValue("0");
                            databaseReference.child("INFO").child("name").setValue(name);
                            databaseReference.child("INFO").child("phone").setValue(phone);
                            databaseReference.child("TOKEN").setValue("0");
